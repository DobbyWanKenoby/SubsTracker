...
protocol STPickerCellProtocol: UITableViewCell, STInputCellProtocol {
    ...
    var didValueChanged: ((UIPickerView) -> Void)? { get set }
    var textForLabelWhenPickerValueChanged: ((UIPickerView) -> String)? { get set }
...
class STPickerCell: UITableViewCell, STPickerCellProtocol {
    ...
    var didValueChanged: ((UIPickerView) -> Void)?
    var textForLabelWhenPickerValueChanged: ((UIPickerView) -> String)? {
        didSet {
            valueLabel.text = textForLabelWhenPickerValueChanged?(valueLabel.pickerView)
        }
    }
...
extension STPickerCell: UIPickerViewDelegate, UIPickerViewDataSource, STLabelPickerInputViewTextDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        valueLabel.textColor = .darkText
        didValueChanged?(pickerView)
    }
    
    func getTextForLabel(_ pickerView: UIPickerView, forSelectedRows: [Int]) -> String {
        return textForLabelWhenPickerValueChanged?(pickerView) ?? ""
    }
}
